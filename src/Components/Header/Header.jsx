...
function Header() {
    return (
      ...
      py-[2rem] px-[7rem] ">
        ...
        <Link className="favorites bg-[#d8a011] px-[1rem] py-[0.5rem] rounded-[5px] font-[Josefinsans] font-[800] text-[17px] text-white no-underline hover:bg-[#ffffff] hover:text-[#f4b315]" to="/favorites"><p>Favoritos</p></Link>
      </div>
    );
  }
