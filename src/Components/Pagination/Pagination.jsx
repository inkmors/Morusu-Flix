  ...
  return (
    <div className="flex items-center w-full max-w-[80%] justify-center gap-[1.5rem] m-[5rem]">
      {[...Array(6)].map((_, index) => {
        ...
        return (
          <Link key={pageNumber} className={`font-[Mulish] font-[800] flex items-center justify-center w-[2rem] h-[2rem] rounded-[10px] bg-[#f4b315] text-[20px] ${currentPage === pageNumber ? "bg-[#fff] text-[#1a141a]" : "text-[#1a141a]"} 
